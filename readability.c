...

{
    ...
    // Theo Lauriette showed me that I had to express L, S, letters, and words as floats because they were used to calculate the average which should use real numbers and not just integers
